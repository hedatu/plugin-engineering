...
const cases = [
  {
    ...
    file: "tests/fixtures-simple.srt",
    outputType: "article",
    expected: "The file stays local"
  },
  {
    name: "chinese obsidian",
    file: "tests/fixtures-chinese.srt",
    outputType: "obsidian",
    expected: "本地完成"
  },
  {
    name: "timestamped duplicate cleanup",
    file: "tests/fixtures-duplicates.srt",
...
try {
  for (const testCase of cases) {
    ...
    await page.locator("#srtInput").setInputFiles(path.join(workspace, testCase.file));
