...

{
  ...
  "notes": "The listing now matches the verified support envelope: local-only storage, no overwrite by default, and common text, email, phone, textarea, and select fields."
}
